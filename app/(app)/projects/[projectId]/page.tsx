  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-8">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link className="rounded-md border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-900" href="/dashboard">
      ...
      <section className="mt-6 rounded-xl border border-gray-200 bg-white p-4">
        ...
        {!loading && documents.length === 0 && <p className="mt-2 text-sm text-gray-600">No documents found yet.</p>}
        <ul className="mt-3 space-y-2">
